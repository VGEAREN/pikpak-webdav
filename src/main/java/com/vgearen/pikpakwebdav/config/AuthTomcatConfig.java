...
@Component
@ConditionalOnProperty(prefix = "pikpak.auth", name = "enable", matchIfMissing = true)
        ...
        tomcatServletWebServerFactory.addContextCustomizers(context -> {
            ...
            RealmBase realm = new RealmBase() {
                ...
                protected String getPassword(String username) {
                    if (pikpakProperties.getAuth().getUserName().equals(username)) {
                        return pikpakProperties.getAuth().getPassword();
                    }
                    return null;
                }
                ...
                protected Principal getPrincipal(String username) {
                    return new GenericPrincipal(username, pikpakProperties.getAuth().getPassword(), Collections.singletonList("**"));
                }
            };
